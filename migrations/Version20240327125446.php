 ...
 */
final class Version20240327125446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT IDENTITY NOT NULL, content NVARCHAR(255) NOT NULL, date DATETIME2(6) NOT NULL, PRIMARY KEY (id))');
